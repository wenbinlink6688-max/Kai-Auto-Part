...
export const categories: Category[] = [
  {
    id: "spoilers",
    name: "Spoilers & Wings",
    description: "GT wings, lip spoilers, ducktails",
    icon: "🏎️",
    productCount: 24,
    image: "/images/categories/spoilers.jpg",
  },
  {
    id: "body-kits",
    name: "Body Kits",
    description: "Full kits, ground effects, wide body",
    icon: "🔧",
    productCount: 18,
    image: "/images/categories/body-kits.jpg",
  },
  {
    id: "grilles",
    name: "Custom Grilles",
    description: "Mesh, billet, honeycomb, CNC",
    icon: "◼️",
    productCount: 32,
  ...
  },
  {
    id: "bumpers",
    name: "Bumpers & Lips",
    description: "Bumpers, lips, splitters, diffusers",
    icon: "🛡️",
    productCount: 28,
  ...
  },
  {
    id: "fender-flares",
    name: "Fender Flares",
    description: "Bolt-on, OE-style, pocket flares",
    icon: "💪",
    productCount: 16,
    image: "/images/categories/fender-flares.jpg",
  },
  {
    id: "side-skirts",
    name: "Side Skirts",
    description: "Rocker panels, extensions, aero",
    icon: "➡️",
    productCount: 20,
    image: "/images/categories/side-skirts.jpg",
  },
  {
    id: "led-lighting",
    name: "LED Lighting",
    description: "Headlights, tails, DRLs, fog lights",
    icon: "💡",
    productCount: 45,
  ...
  },
  {
    id: "chrome-trim",
    name: "Chrome & Trim",
    description: "Delete kits, mirror caps, overlays",
    icon: "✨",
    productCount: 38,
    image: "/images/categories/chrome-trim.jpg",
  },
  {
    id: "window-visors",
    name: "Window Visors",
    description: "Rain guards, wind deflectors",
    icon: "🌧️",
    productCount: 22,
    image: "/images/categories/window-visors.jpg",
  },
  {
    id: "mud-flaps",
    name: "Mud Flaps & Guards",
    description: "Splash guards, mud flaps",
    icon: "🛞",
    productCount: 15,
    image: "/images/categories/mud-flaps.jpg",
  },
  {
    id: "car-covers",
    name: "Car Covers",
    description: "All-weather, indoor, custom-fit",
    icon: "🧥",
    productCount: 20,
  ...
  },
  {
    ...
    description: "Cross bars, cargo boxes, carriers",
    icon: "📦",
    productCount: 26,
